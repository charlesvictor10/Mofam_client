                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="header-logo">
                                        <a href="index.html"><img src="images/logo/1.png" alt="Mt-Shop"></a>
                                    </div>
                                </div>
                                <!--End-logo-area-->
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 hidden-sm hidden-xs">
                                    <div class="log-small"><a class="logo" href="index.html"><img alt="Mt-Shop" src="images/logo/s.png"></a></div>
                                    <div class="mainmenu">
                                        <nav>
                                            <ul id="nav">
                                                    ...
                                                    <div class="megamenu pages">
                                                        <div class="megamenu-list">
                                                            <span class="mega-single pages">
                                                                ...
                                                                <a href="categorie.php">Shop List</a>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="shop-grid.html">Pages</a>
                                                <ul>
                                                    ...
                                                    <li><a href="categorie.php">Shop List</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="four-zero-content">
                                <span class="four-zero-logo"><img src="images/logo/404-img.png" alt=""></span>
