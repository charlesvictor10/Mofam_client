                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="shop-head-menu">
                        <ul>
                            ...
                            <li class="shop-pro">Recherche</li>
                        </ul>
                    </div>
                </div>
                <!--end-shop-head-->
                                ...
                                <div id="shop-product" class="tab-pane">
                                    <div class="row">
                                        ...
                                        if(isset($_POST['submit'])){
                                            $data = $_POST['search'];
                                            $res = recherche_produit($pdo,$data);
                                            foreach($res as $prod){
                                                $im = Liste_par_produits_limite($pdo,$prod[0])
                                        ?>
                                            <!-- Start-single-product -->
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="single-product shop-mar-bottom">
                                                    <div class="product-img-wrap">
                                                        <a class="product-img" href="#"><img src="images/produits/<?php echo $im[0][3]; ?>" alt="<?php echo $prod[1] ?>"/></a>
                                                        <div class="add-to-cart">
                                                            <a href="panier_ajouter.php?action=ajout&prod=<?php echo $prod[0]; ?>&qtte=1&prix=<?php echo $prod[5] ?>&loc=categorie.php?souscat=<?php echo $prod[0]; ?>" title="add to cart">
                                                    ...
                                                    <div class="product-info text-center">
                                                        <div class="product-content">
                                                            <a href="#"><h3 class="pro-name"><?php echo $prod[3]; ?></h3></a>
                                                            ...
                                                            <div class="pro-price">
                                                                ...
                                                                <span class="normal-price"><?php echo $prod[5]; ?> fcfa</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="shop-button-area shop-list">
                                                            <div class="add-to-cartbest shop">
                                                                <a href="panier_ajouter.php?prod=<?php echo $prod[0]; ?>&qtte=1&prix=<?php echo $prod[5]; ?>&loc=categorie.php?souscat=<?php echo $prod[0]; ?>" title="add to cart">
